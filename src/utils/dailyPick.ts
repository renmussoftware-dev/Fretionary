 ...
 *    scale library takes ~28 days and the chord library ~72 days
 *
 * Same input → same output is the point: the card on the home screen, the
 * notification body, and any future "yesterday's pick" surfaces all read
